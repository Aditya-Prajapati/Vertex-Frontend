...
const Navbar = () => {
    ...
    return (
        <>
            <div className={`hamburger ${hamburgerClicked ? "hamburgerActive" : ""}`} onClick={() => setHamburgerClicked((prevState) => !prevState)}>
                <span className="bar"></span>
                <span className="bar"></span>
                <span className="bar"></span>
            </div>
            <div className={`${isScrolled ? "navbar-top scrolled" : "navbar-top"} ${hamburgerClicked ? "navbarActive" : ""}`}>
                <div className="top">
                    <div className="left">
                    ...
                    <div className="right">
                        ...
                        <form className="searchForm" onSubmit={handleSearch}>
                            ...
                            <input ref={searchInputRef} type="text" placeholder="Search" className={searchClicked ? "searchClicked" : ""} value={searchText} onChange={e => setSearchText(e.target.value)} />
                        </form>
